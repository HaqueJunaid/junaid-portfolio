...
const Testimonials: FC = () => {
  ...
  return (
    <section className="py-24 md:py-32 lg:py-46 xl:py-48">
      <h2 className="text-4xl md:text-7xl lg:text-8xl xl:text-9xl flex flex-col overflow-hidden">
      ...
      <div className="container">
        <div className="mt-20 lg:mt-28">
          {testimonials.map(({ name, company, role, quote, image, imagePositionY }, index) => index === testimonialIndex && (
            <div key={name} className="grid md:grid-cols-5 md:gap-8 lg:gap-16 xl:gap-24 md:items-center">
              <div className="aspect-square md:col-span-2  md:aspect-[9/12]">
                <Image src={image} alt={`${name + image}`} className="size-full object-cover" style={{
                  objectPosition: `50% ${imagePositionY * 100}%`
                }} />
              </div>
              <blockquote className="md:col-span-3">
                <div className="text-3xl md:text-5xl lg:text-6xl xl:text-8xl mt-8 md:mt-0">
                  <span>&ldquo;</span>
                  <span>{quote}</span>
                  <span>&rdquo;</span>
                </div>
                <cite className="block mt-4 md:mt-8 xl:mt-12 not-italic md:text-lg lg:text-xl xl:text-2xl">
        ...
        <div className="flex gap-4 mt-6 lg:mt-10">
          <button className="size-11 border border-stone-400 inline-flex items-center justify-center rounded-full">
            <svg
